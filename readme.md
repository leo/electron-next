...
- `<port>`: This port will be used for running [Next.js](https://github.com/zeit/next.js) in development mode (number). This parameter is **optional** and will fall back to `8000`, if it's not defined.
